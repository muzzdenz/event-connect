    ...
    <div class="relative h-[500px] w-full flex items-center justify-center bg-cover bg-center overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1540575467063-178a50c2df87?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80');">
        ...
        <div class="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
            ...
            <div class="max-w-2xl mx-auto">
                <form action="<?php echo e(route('events.index')); ?>" method="GET" class="flex gap-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-12">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('events.index')); ?>" class="text-red-600 hover:text-red-700 font-semibold flex items-center gap-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('participant.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\event-connect\resources\views/participant/events/home.blade.php ENDPATH**/ ?>