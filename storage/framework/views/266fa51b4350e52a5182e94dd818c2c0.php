...
<body class="bg-gray-100">
                    ...
                    <?php if($event->qr_code): ?>
                        <div class="flex flex-col md:flex-row gap-8 items-center justify-center">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-lg border-4" style="border-color: #B22234;">
                                <img src="<?php echo e(asset('storage/' . $event->qr_code)); ?>" 
                        ...
                        <div class="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="text" 
                                       id="qr-code-string" 
                                       value="<?php echo e(basename($event->qr_code, '.png')); ?>" 
                                       readonly
    ...
    <script>
        function downloadQR() {
            const qrImage = document.querySelector('img[alt="QR Code for <?php echo e($event->title); ?>"]');
            if (qrImage) {
...
<?php /**PATH C:\xampp\htdocs\event-connect\resources\views/admin/events/qr-code.blade.php ENDPATH**/ ?>